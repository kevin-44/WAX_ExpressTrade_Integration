...
> **Note**: Log into your VPS with the credentials you previously created from now on (add **sudo** at the beginning of a command if said command requires administrative privileges).
