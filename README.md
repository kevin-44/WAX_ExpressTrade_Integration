...
> **Note**: Calls to `api-trade.opskins.com` should always be executed over the `HTTPS` protocol; otherwise, your call will be redirected and lost (erroneous response).
