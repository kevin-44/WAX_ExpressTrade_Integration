...
> **Note**: `Referral Commission Rate` corresponds to the percentage of how much of the received commission will be shared to users participating in a custom referral program you can add to your website. **This only takes effect when `referral_ui` is assigned a value when invoking the [SendKeyRequest](https://github.com/OPSkins/trade-opskins-api/blob/master/ICaseSite/SendKeyRequest.md) endpoint - in such case, the whole 10% will be added to your OPSkins account instead!**
