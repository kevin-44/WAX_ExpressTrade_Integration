...
- `official` [php-oauth](https://github.com/OPSkins/php-oauth) (can be used for both the [OPSkins OAuth](https://docs.opskins.com/public/en.html#oauth) and [WAX ExpressTrade API](https://github.com/OPSkins/trade-opskins-api))
