...
Hosting your website implies that you rent a **VPS** (*Virtual Private Server*) from a company of choice. There are many companies you can rent a VPS from, although some may require for you to submit a whitelist application beforehand (such as OVH). If you're looking for a decent cheap VPS that's quick to set up, [DigitalOcean](https://www.digitalocean.com) is a great option!