...
<img alt = "PHP - Install php-oauth Step 1" src = "img/php_install_php-oauth_step_1.png">

<img alt = "PHP - Install php-oauth Step 2" src = "img/php_install_php-oauth_step_2.png">
...
Create a `.php` file (or download the `blank.php` file in this repository), name it `index.php`, place it inside of your `public_html` directory, open the file with a text editor ([Sublime Text](https://www.sublimetext.com/3) is recommended) and include `php-oauth`. Your `index.php` file should contain the following:
...
> **Note**: As specified when you configured the name-based virtual hosts (or if you did), your system will look for the file `index.php` when accessing your domain without requesting a specific file (e.g. simply `example.com`).
