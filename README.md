...
No other command in this tutorial should be executed as `root` (except the ones to create a new user). Create a new user and add it to the `sudo` group so you'll have administrative privileges:
