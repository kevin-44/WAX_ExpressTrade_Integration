...
Before anything, you will need to install a **web server** and **PHP**. If you already know how to do this, you can skip to the [next step](#install-dependencies-3). If you're interested in registering a domain and the configuration that comes with it however, click [here](#register-a-domain--configure-name-based-virtual-hosts-1) instead.
