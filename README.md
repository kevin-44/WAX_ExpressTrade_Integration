...
> **Note**: Log into your VPS with the credentials you previously created from now on (add **sudo** at the beginning of a command if administrative privileges is required); although, you can always use the **su** command to switch between users.
