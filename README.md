...
> **Note**: Your `API key` should be passed as `key` (as shown in the code above). The [API documentation for WAX ExpressTrade](https://github.com/OPSkins/trade-opskins-api) doesn't specify this.
