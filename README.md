...
- `official` [php-oauth](https://github.com/OPSkins/php-oauth) (specifically for [OPSkins OAuth](https://docs.opskins.com/public/en.html#oauth); however, it can also be used to invoke the WAX ExpressTrade API)
