...
With the integration of the WAX ExpressTrade API, you can create your own VGO case opening website (such as [UnlockVGO](https://www.unlockvgo.com)) and earn **$0.25** per case opened, set up a trading website where you can also profit from transactions, etc.
